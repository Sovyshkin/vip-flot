<template>
  <div class="board-services">
    <div class="wrap-title">
      ...
      <h3 class="subtitle">Соберите прогулку под свой формат: от камерного вечера до полноценного события с сервисом, музыкой и сопровождением на борту.</h3>
    </div>
    <div class="cards">
      <div class="row-cards">
